...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Feb 2024 pada 15.22
...
(212210216, 'rifandi', '123', '12', 'Rekayasa Perangkat Lunak', 'Depok');
...
--
ALTER TABLE `member`
  MODIFY `nisn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=212210217;
